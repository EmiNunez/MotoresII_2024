...
public class EventManager
{
    ...
    public static EventManager m_Instance //ES UN SINGLETON!
    {
        get
        {
            if (m_instance == null)
    ...
    public void InvokeEvent<T>(T _event) where T : GameEvent //Busca en la libreria si se ejecutó algun evento
    {
        if (_event == null)
        {
